...
def generate_launch_description():
    ...
    default_map_path = PathJoinSubstitution(
        [FindPackageShare('talosbot_navigation'), 'maps', 'wsk_17_54_new.yaml']
    )
    ...
    slam_default_config_path = PathJoinSubstitution(
        [FindPackageShare('talosbot_navigation'), 'config', 'slam_default.yaml']
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            name='slam_default_config', 
            default_value=slam_default_config_path,
            description='SLAM Config Path'
        ),
        ...
        TimerAction(
            actions = [
                ...
                IncludeLaunchDescription(
                    ...
                    launch_arguments={
                        'use_sim_time': LaunchConfiguration("sim"),
                        'slam_params_file': LaunchConfiguration("slam_default_config")
                    }.items(),
                ),
